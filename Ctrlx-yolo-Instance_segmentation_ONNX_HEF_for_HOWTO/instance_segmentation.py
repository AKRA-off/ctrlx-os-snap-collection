...
# Shared storage for detection results from HAILO inference
_detection_results = {
    'boxes': np.array([]),
    'scores': np.array([]),
    'classes': np.array([])
...
def get_detection_results():
    """Return the collected detection results"""
    global _detection_results
    return _detection_results.copy()

def reset_detection_results():
    """Reset detection results before new inference"""
    global _detection_results
    _detection_results = {
        'boxes': np.array([]),
        'scores': np.array([]),
...
def store_detection_results(boxes, scores, classes):
    """Store detection results for retrieval"""
    global _detection_results
    _detection_results = {
        'boxes': boxes,
        'scores': scores,
...
def run_inference_pipeline(
    ...
    Returns:
        dict: Detection results with keys 'boxes', 'scores', 'classes'
    """
    # Reset detection results before starting new inference
    reset_detection_results()

    config_data = load_json_file("/var/snap/rexroth-solutions/common/solutions/activeConfiguration/AI_Detector/config.json")
    ...
    # Return collected detection results
